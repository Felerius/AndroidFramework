...
public final class Louis {
  ...
  private static void extractAssets (AssetManager assets, String asset, File location) {
    Log.d("a", "extractAssets: location: "+location.getAbsolutePath());
    try {
  ...
  private static void extractAssets () {
    ...
    Log.d("extrracting assets", "extractAssets: +datalocation: "+dataDirectory.getAbsolutePath());
    File location = new File(dataDirectory, "liblouis/"+name);
    File oldLocation = new File(dataDirectory, "liblouis/"+oldName);
    File newLocation = new File(dataDirectory, "liblouis/"+newName);
  ...
  private static void updatePackageData () {
    ...
    final File file = new File(Environment.getExternalStorageDirectory(),"liblous/tables");
  ...
  public static void initialize (Context context) {
    synchronized (INITIALIZATION_LOCK) {
      ...
      dataDirectory =new File(Environment.getExternalStorageDirectory().getAbsolutePath());
